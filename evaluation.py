...
def evaluation(detoutput, imageset, annopath, classnames):
    ...
    """
    result_before_merge_path = str(detoutput + '/labels')
...
if __name__ == '__main__':
    ...
    evaluation(
        detoutput='exp2/',
        imageset='/home/yanggang/data/HRSC2016/test/images',
        annopath='/home/yanggang/data/HRSC2016/test/labelTxt/{:s}.txt',
        classnames=classnames
    )

    draw_DOTA_image(imgsrcpath='/home/yanggang/data/HRSC2016/test/images',
                    imglabelspath=r'DOTA_demo_view/detection/result_txt/result_merged',
                    dstpath='DOTA_demo_view/detection/merged_drawed',
